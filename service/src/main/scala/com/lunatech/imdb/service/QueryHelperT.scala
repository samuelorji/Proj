...
import com.lunatech.imdb.service.resolvers.QueryResolver.{CheckIfTypeCastedRequest, CheckIfTypeCastedResponse, GetCoincidenceRequest, GetCoincidenceResponse, ShowAndTitle}
